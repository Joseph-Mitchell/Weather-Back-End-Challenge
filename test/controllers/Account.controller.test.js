...
describe("Controller", () => {
    ...
    describe("pushFavourite", () => {
        ...
        beforeEach(() => {
            ...
            stubbedService.pushNewFavourite.resolves(testAccount);
        });
    ...
    describe("pullFavourite", () => {
        ...
        it("should respond 404 if pullFavourite resolves null", async () => {
            //Arrange
            stubbedService.pullFavourite.resolves(null);
